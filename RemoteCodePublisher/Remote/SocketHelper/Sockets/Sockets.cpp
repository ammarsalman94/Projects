...
bool SocketConnecter::connect(const std::string& ip, size_t port)
{
  ...
  for (ptr = result; ptr != NULL; ptr = ptr->ai_next) {
    ...
    Show::write("\n  " + std::string(ipver) + " " + std::string(ipstr));
...
{
public:
  void operator()(Socket& socket_) const;
  bool testStringHandling(Socket& socket_) const;
  bool testBufferHandling(Socket& socket_) const;
};
...
void ClientHandler::operator()(Socket& socket_) const
{
  while (true)
  {
...
*/
bool ClientHandler::testStringHandling(Socket& socket_) const
{
...
*/
bool ClientHandler::testBufferHandling(Socket& socket_) const
{
