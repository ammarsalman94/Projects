...
namespace Scanner
{
  ...
  public:
    ...
    void returnComments(bool doReturnComments = false);
		void returnSpaces(bool eatSpaces = false);
...
//-----< turn on\off returning spaces as tokens >--------------------
void Scanner::ConsumeState::returnSpaces(bool _doReturnSpaces)
{
	_pContext->_doReturnSpaces = _doReturnSpaces;
}
...
//-----< start/stop returning spaces as tokens >---------------------
void Scanner::Toker::returnSpaces(bool doReturnSpaces) 
{
	pConsumer->returnSpaces(doReturnSpaces);
}
